...
public class Evm extends JPanel implements MouseMotionListener, MouseListener, KeyListener, IEvm {
    ...
    private Image imgDust, imgGrass, imgRobot, imgRobotSuck;
    ...
    public Evm(Window w) {
        this.window = w;
        imgDust = new ImageIcon(getClass().getResource("/Image/iphone.png")).getImage();
    ...
    protected void paintComponent(Graphics g) {
        ...
        for (int i = 0; i < widthEvm; i++) {
            for (int j = 0; j < heightEvm; j++) {
                ...
                if (matrix[i][j] == 1) {
                    g2.drawImage(imgDust, point.x, point.y, widthASquare, heightSquare, this);
                }
            }
        }
        //----radar------
